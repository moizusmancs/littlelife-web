...
const NAV_LINKS = [
  ...
  { label: 'Map', to: '/app/map', icon: MapTrifold },
  { label: 'Community', to: '/app/community', icon: UsersThree },
  { label: 'Resources', to: '/app/resources', icon: FirstAidKit },
]
      ...
      <header className="sticky top-0 z-20 border-b border-surface-border bg-surface-raised">
        <div className="mx-auto flex h-16 max-w-[1440px] items-center gap-4 px-4 md:px-6">
          <NavLink to="/app/home" className="flex flex-none items-center gap-2">
            <div className="flex size-8 items-center justify-center rounded-md bg-gradient-to-br from-primary-500 to-peach-400">
