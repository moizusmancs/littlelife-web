...
/** One shared column template so the header and every row line up from `md` up. Every column but
...
const COLUMNS = 'md:grid-cols-[minmax(0,1fr)_8.5rem_11rem_7.5rem_13rem]'
 ...
 * detail screen) and one status action; the caller's own row offers none. Below `md` each row
        ...
        {accounts.map((account) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 ps-12 md:contents">
              ...
              <div className="flex items-center gap-2 ps-12 md:ps-0 md:justify-end">
                <Link
